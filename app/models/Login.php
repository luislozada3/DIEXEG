<?php
	...
	class Login
	{
		...
		public function save($data){
			$this->db->query("INSERT INTO usuarios (usuario, password, nivel, imagen, estatus) VALUES (:user, :password, :role, :image, :status)");
		...
		/**
		 * [update metodo para editar un usuario]
		 * @param  [int] $id [id del usuario]
		 * @return [boolean] [devuelven true si se actualiza al usuario y false si falla]
		 */
