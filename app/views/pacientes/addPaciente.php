<div class="modal fade" id="modalAddPaciente" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">

      <div class="modal-body">
        <form class="form-horizontal form-material" action="return false;" onsubmit="return false;" id="formAddPaciente">

        <div class="container">
          <div class="modal-header" style="border-bottom: none;">
            
            <h4 class="modal-title">
              <span class="fa fa-plus-circle"></span> Agregar Paciente
            </h4>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                ...
                <select class="form-control form-control-line" id="sexo" name="sexo" autocomple="off" autofocus onchange="selectDisabled(event)">
        ...
        <div class="form-group">
          <label class="col-md-12" for="tlf">Telefono: </label>
          <div class="col-md-12">
            <input type="text" class="form-control form-control-line" id="tlf" name="tlf" autocomplete="off" maxlength='11' onkeypress="return justNumber(event)">
            <span class="textHelp"></span>
          </div>
        </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <input type="number" class="form-control form-control-line" id="peso" name="peso" autocomplete="off" onkeypress="return justNumber(event)">
                <span class="textHelp"></span>
              </div>

              <div class="col-md-4">
                <label for="altura">Altura (mts.)</label>
                <input type="text" class="form-control form-control-line" id="altura" name="altura" autocomplete="off" onkeypress="return justNumberAndPoint(event)">
                <span class="textHelp"></span>
              </div>
        ...
        <div class="form-group">
            <div class="col-sm-12">
              <button type="submit" class="btn btn-primary btn-blue" id="btnAddPaciente" style="margin-left: 0px;">Aceptar
              </button>
